...
const SkillsAvailable = () => {
    return (
        <div className='mt-10 2xl:w-[800px] 2xl:ml-7'>
                ...
                <div>
                    <fieldset className="w-full space-y-1 ">
                        ...
                        <div className="relative">
                            ...
                            <input type="search" name="Search" placeholder="Search..." className="w-32 py-1 pl-10 text-sm rounded-md sm:w-auto focus:outline-none  focus:bg-white focus:border-violet-400" />
                        </div>
                    </fieldset>
                </div>
            </div>
