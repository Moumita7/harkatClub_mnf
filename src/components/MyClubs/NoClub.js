  ...
  return (
    <div>
       <div style={{fontWeight:"bolder",color:"#ED3344",fontSize:"25px"}}>YOU HAVE NEITHER PROPOSED NOR JOINED ANY CLUB</div>
              ...
              <button className="mnf_btn hover:primary-bg text-[#ee3c4d] font-semibold rounded-xl text-xl hover:text-white py-2 px-5"><a href="http://115.245.192.138/harkat/propose">Propose Club</a> </button>
